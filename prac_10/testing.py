...
def format_phrase_as_sentence(phrase):
    """
    Format a passed in phrase as a sentence
    >>> format_phrase_as_sentence("hello")
    'Hello.'
    >>> format_phrase_as_sentence("It is an ex parrot.")
    'It is an ex parrot.'
    >>> format_phrase_as_sentence("this is sparta")
    'This is sparta.'
    """
...
def run_tests():
    ...
    test_car2 = Car()
    assert test_car.fuel == 10, "Car fuel is not set correctly"
    assert test_car2.fuel == 0, "Default Car fuel is not set correctly"
