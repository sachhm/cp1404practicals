...
lowercase_names = [name.lower() for name in full_names]
...
filtered_names = [full_name for full_name in full_names if len(full_name) > 11]
last_names = [name.split(" ") for name in filtered_names]
